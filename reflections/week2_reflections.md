...
As we continued reviewing, this problem of recursion was an incredible focus. A concept that I thought I still remembered
well actually felt quite foreign. On the surface calling a method from within itself was still in my mind, but the logic
behind designing an algorithm using this technique took me longer to figure out than I was anticipating.

After spending some time fiddling with the maze solver problem, I was able to figure out a solution, but to a certain extent
...
step down from where it is currently until the base case is reached. 